...
/// </param>
public record MoveProductsToAnotherWarehouseCommand(string ProductId, string OldWarehouseId, string NewWarehouseId, DateOnly MovedStockExpirationDate, int MovedQuantity);